...
/**
 * A key for debouncing events by block location.
 *
 * Identifies a block by its world name and coordinates, so that rapid
 * repeated events (e.g. redstone changes, liquid flow) for the same
 * block are coalesced into a single processing pass.
 */
